    ...
    return (
        <div className="w-80 h-16 p-2 bg-white border-tangerine-500 border-t border-x last-of-type:border-b">
            <div className="w-full h-full flex justify-between items-center px-8">
                <p>Loading...</p>
                <div role="status">
                    <svg aria-hidden="true" className="w-8 h-8 text-gray-200 animate-spin dark:text-gray-200 fill-green-600" viewBox="0 0 100 101" fill="none" xmlns="http://www.w3.org/2000/svg">
