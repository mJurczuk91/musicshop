...
export default function CommentDisplay({ comment, abbreviateCommentsLongerThan }: Props) {
    ...
    return (
        <div className="flex flex-row w-full max-w-6xl mx-4 px-4 mt-2 border-gray-500 border-t-2">
            ...
            <div className="basis-4/5">
                <p>{isAbbreviated ? comment.message.slice(0, abbreviateCommentsLongerThan).concat('...') : comment.message}</p>
