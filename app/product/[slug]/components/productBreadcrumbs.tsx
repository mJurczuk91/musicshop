    ...
    return (
        <div className="w-full py-2 px-4 border-gray-400 border-opacity-25 border-b-2">
            <div>
                ...
                <Link href={`/category/${product.categoryId.concat('-').concat(product.category.replaceAll(' ', '-'))}`}>
                ...
                <Link href={`/category/${product.categoryId.concat('-').concat(product.category.replaceAll(' ', '-'))}/${getSubcategorySlug({id: product.subcategoryId, name: product.subcategory})}`}>
                    <span className="capitalize">
                        {product.subcategory}
                    </span>
                </Link>
